...
var interactions_11810030 = [[]];
interactions_11810030[0].push({title: "Client initialization", description: "The first thing the client should do is to connect to the server.", steps: [{kind: 2, description: "The first thing to do is to send a connection request to unix domain socket which\nis located at user runtime directory inside `kisa` directory with an <ID> of a\ncurrently running session (by convention it is the process ID of the server).\nBelow is an example for a Zig language, see documentation of\n[socket(2)] and [connect(2)] for more information.\n\n[socket(2)]: https://linux.die.net/man/2/socket\n[connect(2)]: https://linux.die.net/man/2/connect\n", other: "const std = @import(\"std\");\nconst os = std.os;\nconst allocator = ...;\nconst address = allocator.create(std.net.Address);\naddress.* = try std.net.Address.initUnix(\"/var/run/user/1000/kisa/<ID>\");\nconst socket = try os.socket(\n    os.AF_UNIX,\n    os.SOCK_SEQPACKET | os.SOCK_CLOEXEC,\n    os.PF_UNIX,\n);\nos.connect(socket, &address.any, address.getOsSockLen());\n", request: ({method: null, params: ({kind: 0, bVal: false, iVal: 0, fVal: 0.0, sVal: null, aVal: []}), notification: false}), to: 0, response: ({notification: false, kind: 0, result: ({kind: 0, bVal: false, iVal: 0, fVal: 0.0, sVal: null, aVal: []}), error: ({code: 0, message: null})}), from: 0}, {kind: 0, description: "After that the server notifies the client that the connection was accepted\nand sends a notification saying that the client must ask for its ID.\n", to: 0, request: {method: "shouldAskId", params: {kind: 0, bVal: false, iVal: 0, fVal: 0.0, sVal: null, aVal: []}, notification: true}, response: ({notification: false, kind: 0, result: ({kind: 0, bVal: false, iVal: 0, fVal: 0.0, sVal: null, aVal: []}), error: ({code: 0, message: null})}), from: 0, other: null}, {kind: 0, description: "After receiving a notification, the client asks for an ID.\n", to: 1, request: {method: "askId", params: {kind: 0, bVal: false, iVal: 0, fVal: 0.0, sVal: null, aVal: []}, notification: false}, response: ({notification: false, kind: 0, result: ({kind: 0, bVal: false, iVal: 0, fVal: 0.0, sVal: null, aVal: []}), error: ({code: 0, message: null})}), from: 0, other: null}, {kind: 1, description: "Server sends an ID which it assigned to the client.\n", from: 1, response: {kind: 0, result: {kind: 1, bVal: true, iVal: 0, fVal: 0.0, sVal: null, aVal: []}, notification: false, error: ({code: 0, message: null})}, request: ({method: null, params: ({kind: 0, bVal: false, iVal: 0, fVal: 0.0, sVal: null, aVal: []}), notification: false}), to: 0, other: null}]});;
...
function applyEvents_11010073(n_11010075) {
    ...
    L1: do {
      var i_11010089 = 0;
      var colontmp__11835379 = 0;
      colontmp__11835379 = (n_11010075.events).length;
      var i_11835380 = 0;
      L2: do {
          L3: while (true) {
          if (!(i_11835380 < colontmp__11835379)) break L3;
            i_11010089 = i_11835380;
            ...
            i_11835380 = addInt(i_11835380, 1);
          }
      } while(false);
    } while(false);
...
function applyStyle_10455628(n_10455630, s_10455631) {
    ...
    L1: do {
      var i_10455664 = 0;
      var colontmp__11835390 = 0;
      colontmp__11835390 = subInt(s_10455631.length, 1);
      var res_11835391 = 0;
      L2: do {
          L3: while (true) {
          if (!(res_11835391 <= colontmp__11835390)) break L3;
            i_10455664 = res_11835391;
            n_10455630.style[s_10455631[i_10455664]] = s_10455631[addInt(i_10455664, 1)];
            res_11835391 = addInt(res_11835391, 2);
          }
      } while(false);
    } while(false);
  ...
  BeforeRet: do {
    ...
    break BeforeRet;
      ...
      L1: do {
        ...
        L2: do {
          var i_11835348 = 0;
          var colontmp__11835349 = 0;
          colontmp__11835349 = (n_11010156.kids).length;
          var i_11835350 = 0;
          L3: do {
              L4: while (true) {
              if (!(i_11835350 < colontmp__11835349)) break L4;
                i_11835348 = i_11835350;
                k_11135016 = n_11010156.kids[chckIndx(i_11835348, 0, (n_11010156.kids).length-1)];
                result_11010159.appendChild(toDom_11010154(k_11135016, useAttachedNode_11010157, kxi_11010158));
                i_11835350 = addInt(i_11835350, 1);
              }
          } while(false);
        } while(false);
      } while(false);
    ...
    L5: do {
      ...
      L6: do {
        var i_11835361 = 0;
        var colontmp__11835362 = 0;
        colontmp__11835362 = subInt((n_11010156.attrs).length, 2);
        var res_11835363 = 0;
        L7: do {
            L8: while (true) {
            if (!(res_11835363 <= colontmp__11835362)) break L8;
              i_11835361 = res_11835363;
              k_11150001 = n_11010156.attrs[chckIndx(i_11835361, 0, (n_11010156.attrs).length-1)];
              v_11150002 = n_11010156.attrs[chckIndx(addInt(i_11835361, 1), 0, (n_11010156.attrs).length-1)];
              if (!((v_11150002 == null))) {
              result_11010159.setAttribute(k_11150001, v_11150002);
              }
              
              res_11835363 = addInt(res_11835363, 2);
            }
        } while(false);
      } while(false);
    } while(false);
...
function same_11160072(n_11160074, e_11160075, nesting_11160076) {
  ...
  BeforeRet: do {
    ...
    L3: do {
      var i_11175208 = 0;
      var colontmp__11835397 = 0;
      colontmp__11835397 = len_10550014(n_11160074);
      var i_11835398 = 0;
      L4: do {
          L5: while (true) {
          if (!(i_11835398 < colontmp__11835397)) break L5;
            i_11175208 = i_11835398;
            if (!(same_11160072(HEX5BHEX5D_10550036(n_11160074, i_11175208), e_11160075.childNodes[i_11175208], addInt(nesting_11160076, 1)))) {
            result_11160078 = false;
            break BeforeRet;
            }
            
            i_11835398 = addInt(i_11835398, 1);
          }
      } while(false);
    } while(false);
    }
...
function eq_10420229(a_10420231, b_10420232) {
  ...
  BeforeRet: do {
    ...
    L1: do {
      var i_10425083 = 0;
      var colontmp__11835437 = 0;
      colontmp__11835437 = a_10420231.length;
      var i_11835438 = 0;
      L2: do {
          L3: while (true) {
          if (!(i_11835438 < colontmp__11835437)) break L3;
            i_10425083 = i_11835438;
            if (!((a_10420231[i_10425083] == b_10420232[i_10425083]))) {
            result_10420233 = false;
            break BeforeRet;
            }
            
            i_11835438 = addInt(i_11835438, 1);
          }
      } while(false);
    } while(false);
    result_10420233 = true;
...
function sameAttrs_10561079(a_10561081, b_10561082) {
  ...
  BeforeRet: do {
    ...
    L1: do {
      var i_10561106 = 0;
      var colontmp__11835441 = 0;
      colontmp__11835441 = (a_10561081.attrs).length;
      var i_11835442 = 0;
      L2: do {
          L3: while (true) {
          if (!(i_11835442 < colontmp__11835441)) break L3;
            i_10561106 = i_11835442;
            ...
            i_11835442 = addInt(i_11835442, 1);
          }
      } while(false);
    } while(false);
    }
...
function eq_11175614(a_11175616, b_11175617, recursive_11175618) {
  ...
  BeforeRet: do {
    ...
    L1: do {
      var i_11205008 = 0;
      var colontmp__11835429 = 0;
      colontmp__11835429 = len_10550014(a_11175616);
      var i_11835430 = 0;
      L2: do {
          L3: while (true) {
          if (!(i_11835430 < colontmp__11835429)) break L3;
            i_11205008 = i_11835430;
            if ((eq_11175614(HEX5BHEX5D_10550036(a_11175616, i_11205008), HEX5BHEX5D_10550036(b_11175617, i_11205008), recursive_11175618) == 1)) {
            result_11175619 = 1;
            break BeforeRet;
            }
            
            i_11835430 = addInt(i_11835430, 1);
          }
      } while(false);
    } while(false);
    }
    ...
    L6: do {
      var i_11230008 = 0;
      var colontmp__11835433 = 0;
      colontmp__11835433 = len_10550014(a_11175616);
      var i_11835434 = 0;
      L7: do {
          L8: while (true) {
          if (!(i_11835434 < colontmp__11835433)) break L8;
            i_11230008 = i_11835434;
            if (!((eq_11175614(HEX5BHEX5D_10550036(a_11175616, i_11230008), HEX5BHEX5D_10550036(b_11175617, i_11230008), true) == 3))) {
            result_11175619 = 1;
            break BeforeRet;
            }
            
            i_11835434 = addInt(i_11835434, 1);
          }
      } while(false);
    } while(false);
    }
...
function updateAttributes_11245052(newNode_11245054, oldNode_11245055) {
    ...
    L1: do {
      ...
      L2: do {
        var i_11835447 = 0;
        var colontmp__11835448 = 0;
        colontmp__11835448 = subInt((oldNode_11245055.attrs).length, 2);
        var res_11835449 = 0;
        L3: do {
            L4: while (true) {
            if (!(res_11835449 <= colontmp__11835448)) break L4;
              i_11835447 = res_11835449;
              k_11250009 = oldNode_11245055.attrs[chckIndx(i_11835447, 0, (oldNode_11245055.attrs).length-1)];
              __11250010 = oldNode_11245055.attrs[chckIndx(addInt(i_11835447, 1), 0, (oldNode_11245055.attrs).length-1)];
              oldNode_11245055.dom.removeAttribute(k_11250009);
              res_11835449 = addInt(res_11835449, 2);
            }
        } while(false);
      } while(false);
    } while(false);
    L5: do {
      ...
      L6: do {
        var i_11835455 = 0;
        var colontmp__11835456 = 0;
        colontmp__11835456 = subInt((newNode_11245054.attrs).length, 2);
        var res_11835457 = 0;
        L7: do {
            L8: while (true) {
            if (!(res_11835457 <= colontmp__11835456)) break L8;
              i_11835455 = res_11835457;
              k_11250011 = newNode_11245054.attrs[chckIndx(i_11835455, 0, (newNode_11245054.attrs).length-1)];
              v_11250012 = newNode_11245054.attrs[chckIndx(addInt(i_11835455, 1), 0, (newNode_11245054.attrs).length-1)];
              if (!((v_11250012 == null))) {
              oldNode_11245055.dom.setAttribute(k_11250011, v_11250012);
              }
              
              res_11835457 = addInt(res_11835457, 2);
            }
        } while(false);
      } while(false);
    } while(false);
...
function getAttr_10500183(n_10500185, key_10500186) {
  ...
  BeforeRet: do {
    L1: do {
      var i_10500200 = 0;
      var colontmp__11835462 = 0;
      colontmp__11835462 = subInt((n_10500185.attrs).length, 2);
      var res_11835463 = 0;
      L2: do {
          L3: while (true) {
          if (!(res_11835463 <= colontmp__11835462)) break L3;
            i_10500200 = res_11835463;
            ...
            res_11835463 = addInt(res_11835463, 2);
          }
      } while(false);
    } while(false);
  } while (false);
...
function removeAllEventHandlers_10897437(d_10897439) {
    ...
    L1: do {
      var i_10900041 = 0;
      var colontmp__11835469 = 0;
      colontmp__11835469 = d_10897439.karaxEvents.length;
      var i_11835470 = 0;
      L2: do {
          L3: while (true) {
          if (!(i_11835470 < colontmp__11835469)) break L3;
            i_10900041 = i_11835470;
            d_10897439.removeEventListener(d_10897439.karaxEvents[i_10900041]["Field0"], d_10897439.karaxEvents[i_10900041]["Field1"]);
            i_11835470 = addInt(i_11835470, 1);
          }
      } while(false);
    } while(false);
    }
...
function diff_11310215(newNode_11310217, oldNode_11310218, parent_11310219, current_11310220, kxi_11310221) {
  ...
  BeforeRet: do {
    ...
    case 2:
      ...
      L8: do {
        var i_11340024 = 0;
        var colontmp__11835404 = 0;
        colontmp__11835404 = subInt(pos_11340018, 1);
        var res_11835405 = commonPrefix_11330202;
        L9: do {
            L10: while (true) {
            if (!(res_11835405 <= colontmp__11835404)) break L10;
              i_11340024 = res_11835405;
              ...
              res_11835405 = addInt(res_11835405, 1);
            }
        } while(false);
      } while(false);
      ...
      L11: do {
        var i_11340030 = 0;
        var res_11835411 = pos_11340018;
        L12: do {
            L13: while (true) {
            if (!(res_11835411 <= newPos_11330215)) break L13;
              i_11340030 = res_11835411;
              addPatch_11260414(kxi_11310221, 2, current_11310220, null, HEX5BHEX5D_10550036(newNode_11310217, i_11340030), null);
              res_11835411 = addInt(res_11835411, 1);
            }
        } while(false);
      } while(false);
      }
        ...
        L14: do {
          var i_11340037 = 0;
          var res_11835417 = pos_11340018;
          L15: do {
              L16: while (true) {
              if (!(res_11835417 <= newPos_11330215)) break L16;
                i_11340037 = res_11835417;
                addPatch_11260414(kxi_11310221, 3, current_11310220, before_11340031, HEX5BHEX5D_10550036(newNode_11310217, i_11340037), null);
                res_11835417 = addInt(res_11835417, 1);
              }
          } while(false);
        } while(false);
      }
      ...
      L17: do {
        var i_11340043 = 0;
        var res_11835423 = pos_11340018;
        L18: do {
            L19: while (true) {
            if (!(res_11835423 <= oldPos_11330214)) break L19;
              i_11340043 = res_11835423;
              ...
              res_11835423 = addInt(res_11835423, 1);
            }
        } while(false);
      } while(false);
      break;
...
function moveDom_11270048(dest_11270050, src_11270051) {
    ...
    L1: do {
      var i_11285208 = 0;
      var colontmp__11835481 = 0;
      colontmp__11835481 = len_10550014(dest_11270050);
      var i_11835482 = 0;
      L2: do {
          L3: while (true) {
          if (!(i_11835482 < colontmp__11835481)) break L3;
            i_11285208 = i_11835482;
            moveDom_11270048(HEX5BHEX5D_10550036(dest_11270050, i_11285208), HEX5BHEX5D_10550036(src_11270051, i_11285208));
            i_11835482 = addInt(i_11835482, 1);
          }
      } while(false);
    } while(false);
...
function applyPatch_11285222(kxi_11285224) {
    L1: do {
      ...
      L2: do {
          L3: while (true) {
          if (!(i_11835475 < kxi_11285224.patchLen)) break L3;
            i_11285232 = i_11835475;
            ...
            i_11835475 = addInt(i_11835475, 1);
          }
      } while(false);
    } while(false);
    ...
    L4: do {
      ...
      L5: do {
          L6: while (true) {
          if (!(i_11835478 < kxi_11285224.patchLenV)) break L6;
            i_11295013 = i_11835478;
            ...
            i_11835478 = addInt(i_11835478, 1);
          }
      } while(false);
    } while(false);
...
function tree_10560445(kind_10560447, kids_10560449) {
  var result_10560450 = null;
    ...
    L1: do {
      ...
      L2: do {
          L3: while (true) {
          if (!(i_11835504 < (kids_10560449).length)) break L3;
            k_10560483 = kids_10560449; k_10560483_Idx = chckIndx(i_11835504, 0, (kids_10560449).length-1);
            add_10550072(result_10560450, k_10560483[k_10560483_Idx]);
            i_11835504 = addInt(i_11835504, 1);
          }
      } while(false);
    } while(false);
...
function quoteString_11666088(str_11666090) {
  var result_11666091 = null;

    var rs_11666092 = [];
    L1: do {
      var ch_11666093 = 0;
      var i_11835518 = 0;
      var L_11835519 = ((str_11666090) == null ? 0 : (str_11666090).length);
      L2: do {
          L3: while (true) {
          if (!(i_11835518 < L_11835519)) break L3;
            ch_11666093 = str_11666090.charCodeAt(chckIndx(i_11835518, 0, (str_11666090).length-1));
            if ((ch_11666093 == 34)) {
            addChar(rs_11666092, 92);;
            addChar(rs_11666092, 34);;
            }
            else {
            addChar(rs_11666092, ch_11666093);;
            }
            
            i_11835518 = addInt(i_11835518, 1);
          }
      } while(false);
    } while(false);
    result_11666091 = toJSStr(rs_11666092);

  return result_11666091;

}
function toCode_11666107(p_11666109) {
      var Tmp1;
      var Tmp2;
      var Tmp3;
      var Tmp4;
  ...
  var result_11666110 = null;

    switch (p_11666109.kind) {
    case 0:
      if (true) {
      failedAssertImpl_1305480(makeNimstrLit("jsonrpc_schema.nim(62, 21) `false` "));
      }
      
      break;
    case 1:
      var Tmp1 = p_11666109;
      if (ConstSet4[Tmp1.kind]===undefined) { raiseFieldError(makeNimstrLit("\'bVal\' is not accessible using discriminant \'kind\' of type \'Parameter\'")); }
      result_11666110 = toJSStr(nimBoolToStr(Tmp1.bVal));
      break;
    case 2:
      var Tmp2 = p_11666109;
      if (ConstSet5[Tmp2.kind]===undefined) { raiseFieldError(makeNimstrLit("\'iVal\' is not accessible using discriminant \'kind\' of type \'Parameter\'")); }
      result_11666110 = toJSStr(cstrToNimstr((Tmp2.iVal)+""));
      break;
    case 3:
      var Tmp3 = p_11666109;
      if (ConstSet6[Tmp3.kind]===undefined) { raiseFieldError(makeNimstrLit("\'fVal\' is not accessible using discriminant \'kind\' of type \'Parameter\'")); }
      result_11666110 = toJSStr(cstrToNimstr(nimFloatToString(Tmp3.fVal)));
      break;
    case 4:
      var fmtRes_11675207 = [mnewString(0)];
      fmtRes_11675207[0].push.apply(fmtRes_11675207[0], makeNimstrLit("\""));;
      var Tmp4 = p_11666109;
      if (ConstSet7[Tmp4.kind]===undefined) { raiseFieldError(makeNimstrLit("\'sVal\' is not accessible using discriminant \'kind\' of type \'Parameter\'")); }
      add_1357211(fmtRes_11675207, 0, quoteString_11666088(Tmp4.sVal));
      fmtRes_11675207[0].push.apply(fmtRes_11675207[0], makeNimstrLit("\""));;
      result_11666110 = toJSStr(fmtRes_11675207[0]);
      break;
    case 5:
      result_11666110 = "[";
      L5: do {
        var parameter_11695214 = null;
        var colontmp__11835511 = [];
        var Tmp6 = p_11666109;
        if (ConstSet8[Tmp6.kind]===undefined) { raiseFieldError(makeNimstrLit("\'aVal\' is not accessible using discriminant \'kind\' of type \'Parameter\'")); }
        colontmp__11835511 = Tmp6.aVal;
        var i_11835513 = 0;
        var L_11835514 = (colontmp__11835511).length;
        L7: do {
            L8: while (true) {
            if (!(i_11835513 < L_11835514)) break L8;
              parameter_11695214 = colontmp__11835511[chckIndx(i_11835513, 0, (colontmp__11835511).length-1)];
              if (null != (Tmp9 = toCode_11666107(parameter_11695214), Tmp9)) { if (null == result_11666110) result_11666110 = Tmp9; else result_11666110 += Tmp9; };
              if (null != ", ") { if (null == result_11666110) result_11666110 = ", "; else result_11666110 += ", "; };
              i_11835513 = addInt(i_11835513, 1);
              if (!(((colontmp__11835511).length == L_11835514))) {
  ...
  return result_11666110;

}
function toCode_11735015(r_11735017) {
    var Tmp1;

  var result_11735018 = null;

    var fmtRes_11735019 = [mnewString(0)];
    fmtRes_11735019[0].push.apply(fmtRes_11735019[0], makeNimstrLit("{\"jsonrpc\": \"2.0\", \"method\": \""));;
    add_1357211(fmtRes_11735019, 0, r_11735017.method);
    fmtRes_11735019[0].push.apply(fmtRes_11735019[0], makeNimstrLit("\""));;
    result_11735018 = toJSStr(fmtRes_11735019[0]);
    if (!((r_11735017.params.kind == 0))) {
    var fmtRes_11750006 = [mnewString(0)];
    fmtRes_11750006[0].push.apply(fmtRes_11750006[0], makeNimstrLit(", \"params\": "));;
    add_1357211(fmtRes_11750006, 0, toCode_11666107(r_11735017.params));
    if (null != (Tmp1 = toJSStr(fmtRes_11750006[0]), Tmp1)) { if (null == result_11735018) result_11735018 = Tmp1; else result_11735018 += Tmp1; };
    }
    
    if (!(r_11735017.notification)) {
    if (null != ", \"id\": 1") { if (null == result_11735018) result_11735018 = ", \"id\": 1"; else result_11735018 += ", \"id\": 1"; };
    }
    
    if (null != "}") { if (null == result_11735018) result_11735018 = "}"; else result_11735018 += "}"; };

  return result_11735018;
...
function parseSaturatedNatural_2245017(s_2245019, b_2245021, b_2245021_Idx, start_2245022) {
  ...
  var result_2245024 = 0;
    ...
    i_2245025 = addInt(i_2245025, 1);
      ...
      if (!(i_2245025 < (s_2245019).length)) Tmp1 = false; else {        Tmp1 = (ConstSet16[s_2245019[chckIndx(i_2245025, 0, (s_2245019).length-1)]] != undefined);      }    if (Tmp1) {
    b_2245021[b_2245021_Idx] = 0;
    L2: do {
        L3: while (true) {
          if (!(i_2245025 < (s_2245019).length)) Tmp4 = false; else {            Tmp4 = (ConstSet17[s_2245019[chckIndx(i_2245025, 0, (s_2245019).length-1)]] != undefined);          }        if (!Tmp4) break L3;
...
function HEX5BHEX5D_5890068(s_5890072, x_5890074) {
  var result_5890075 = [];
    ...
    L1: do {
      ...
      L2: do {
          L3: while (true) {
          if (!(i_11835535 < L_5890401)) break L3;
            i_5890409 = i_11835535;
            ...
            i_11835535 = addInt(i_11835535, 1);
          }
      } while(false);
    } while(false);
...
function parseStandardFormatSpecifier_11550322(s_11550324, start_11550325, ignoreUnknownSuffix_11550327) {
  ...
  var result_11550328 = ({fill: 0, align: 0, sign: 0, alternateForm: false, padWithZero: false, minimumWidth: 0, precision: 0, typ: 0, endPosition: 0});
    ...
    if (((addInt(i_11550331, 1) < (s_11550324).length) && (ConstSet12[s_11550324[chckIndx(addInt(i_11550331, 1), 0, (s_11550324).length-1)]] != undefined))) {
    ...
    if (((i_11550331 < (s_11550324).length) && (ConstSet13[s_11550324[chckIndx(i_11550331, 0, (s_11550324).length-1)]] != undefined))) {
    ...
    i_11550331 = addInt(i_11550331, 1);
      ...
      if (!((addInt(i_11550331, 1) < (s_11550324).length) && (s_11550324[chckIndx(i_11550331, 0, (s_11550324).length-1)] == 48))) Tmp1 = false; else {        Tmp1 = (ConstSet15[s_11550324[chckIndx(addInt(i_11550331, 1), 0, (s_11550324).length-1)]] != undefined);      }    if (Tmp1) {
    ...
    i_11550331 = addInt(i_11550331, parsedLengthB_11570029);
      ...
      if (!(i_11550331 < (s_11550324).length)) Tmp2 = false; else {        Tmp2 = (ConstSet18[s_11550324[chckIndx(i_11550331, 0, (s_11550324).length-1)]] != undefined);      }    if (Tmp2) {
...
function nsuRepeatChar(c_9940124, count_9940125) {
  var result_9940126 = [];
    ...
    L1: do {
      var i_9940135 = 0;
      var colontmp__11835552 = 0;
      colontmp__11835552 = subInt(count_9940125, 1);
      var res_11835553 = 0;
      L2: do {
          L3: while (true) {
          if (!(res_11835553 <= colontmp__11835552)) break L3;
            i_9940135 = res_11835553;
            result_9940126[chckIndx(i_9940135, 0, (result_9940126).length-1)] = c_9940124;
            res_11835553 = addInt(res_11835553, 1);
          }
      } while(false);
    } while(false);
...
function formatInt_11720002(n_11720005, radix_11720006, spec_11720007) {
    var Tmp7;

  var result_11720008 = [];

    var v_11720201 = n_11720005;
    var negative_11720202 = (v_11720201 < 0);
    if (negative_11720202) {
    v_11720201 = mulInt(v_11720201, -1);
    }
    
    var xx_11720203 = [];
    if (spec_11720007.alternateForm) {
    switch (spec_11720007.typ) {
    case 88:
      xx_11720203 = nimCopy(null, makeNimstrLit("0x"), NTI1188013);
      break;
    case 120:
      xx_11720203 = nimCopy(null, makeNimstrLit("0x"), NTI1188013);
      break;
    case 98:
      xx_11720203 = nimCopy(null, makeNimstrLit("0b"), NTI1188013);
      break;
    case 111:
      xx_11720203 = nimCopy(null, makeNimstrLit("0o"), NTI1188013);
      break;
    default: 
      break;
    }
    ...
    if ((v_11720201 == 0)) {
    result_11720008 = nimCopy(null, makeNimstrLit("0"), NTI1188013);
    }
    else {
      result_11720008 = nimCopy(null, [], NTI1188013);
      L1: do {
          L2: while (true) {
          if (!(0 < v_11720201)) break L2;
            var d_11720206 = modInt(v_11720201, radix_11720006);
            v_11720201 = divInt(v_11720201, radix_11720006);
            result_11720008.push.apply(result_11720008, mkDigit_11541055(chckRange(d_11720206, -2147483648, 2147483647), spec_11720007.typ));;
          }
      } while(false);
      L3: do {
        var idx_11720215 = 0;
        var colontmp__11835544 = 0;
        colontmp__11835544 = divInt((result_11720008).length, 2);
        var i_11835545 = 0;
        L4: do {
            L5: while (true) {
            if (!(i_11835545 < colontmp__11835544)) break L5;
              idx_11720215 = i_11835545;
              var Tmp6 = result_11720008[chckIndx(idx_11720215, 0, (result_11720008).length-1)]; result_11720008[chckIndx(idx_11720215, 0, (result_11720008).length-1)] = result_11720008[chckIndx(subInt(subInt((result_11720008).length, idx_11720215), 1), 0, (result_11720008).length-1)]; result_11720008[chckIndx(subInt(subInt((result_11720008).length, idx_11720215), 1), 0, (result_11720008).length-1)] = Tmp6;              i_11835545 = addInt(i_11835545, 1);
            }
        } while(false);
      } while(false);
    }
    
    if (spec_11720007.padWithZero) {
    if (negative_11720202) Tmp7 = true; else {      Tmp7 = !((spec_11720007.sign == 45));    }    var sign_11730008 = Tmp7;
    var toFill_11730013 = subInt(subInt(subInt(spec_11720007.minimumWidth, (result_11720008).length), (xx_11720203).length), (sign_11730008 ? 1:0));
    if ((0 < toFill_11730013)) {
    result_11720008 = nimCopy(null, (nsuRepeatChar(48, chckRange(toFill_11730013, 0, 2147483647)) || []).concat(result_11720008 || []), NTI1188013);
    }
    
    }
    
    if (negative_11720202) {
    result_11720008 = nimCopy(null, (makeNimstrLit("-") || []).concat(xx_11720203 || [],result_11720008 || []), NTI1188013);
    }
    else {
    if (!((spec_11720007.sign == 45))) {
    result_11720008 = nimCopy(null, [spec_11720007.sign].concat(xx_11720203 || [],result_11720008 || []), NTI1188013);
    }
    else {
      result_11720008 = nimCopy(null, (xx_11720203 || []).concat(result_11720008 || []), NTI1188013);
    }
    }
    if ((spec_11720007.align == 60)) {
    L8: do {
      var i_11730019 = 0;
      var colontmp__11835548 = 0;
      colontmp__11835548 = (result_11720008).length;
      var i_11835549 = colontmp__11835548;
      L9: do {
          L10: while (true) {
          if (!(i_11835549 < spec_11720007.minimumWidth)) break L10;
            i_11730019 = i_11835549;
            addChar(result_11720008, spec_11720007.fill);;
            i_11835549 = addInt(i_11835549, 1);
          }
      } while(false);
    } while(false);
    }
    else {
      var toFill_11730020 = subInt(spec_11720007.minimumWidth, (result_11720008).length);
      if ((spec_11720007.align == 94)) {
      var half_11730021 = divInt(toFill_11730020, 2);
      result_11720008 = nimCopy(null, (nsuRepeatChar(spec_11720007.fill, chckRange(half_11730021, 0, 2147483647)) || []).concat(result_11720008 || [],nsuRepeatChar(spec_11720007.fill, chckRange(subInt(toFill_11730020, half_11730021), 0, 2147483647)) || []), NTI1188013);
      }
      else {
        if ((0 < toFill_11730020)) {
        result_11720008 = nimCopy(null, (nsuRepeatChar(spec_11720007.fill, chckRange(toFill_11730020, 0, 2147483647)) || []).concat(result_11720008 || []), NTI1188013);
        }
  ...
  return result_11720008;

}
function formatValue_11715002(result_11715005, result_11715005_Idx, value_11715006, specifier_11715007) {
  BeforeRet: do {
    if (((specifier_11715007).length == 0)) {
    result_11715005[result_11715005_Idx].push.apply(result_11715005[result_11715005_Idx], cstrToNimstr((value_11715006)+""));;
    break BeforeRet;
    }
    
    var spec_11715008 = parseStandardFormatSpecifier_11550322(specifier_11715007, 0, false);
    var radix_11715010 = 10;
    switch (spec_11715008.typ) {
    case 120:
    case 88:
      radix_11715010 = 16;
      break;
    ...
    case 111:
      ...
      break;
    default: 
      raiseException({message: (makeNimstrLit("invalid type in format string for number, expected one  of \'x\', \'X\', \'b\', \'d\', \'o\' but got: ") || []).concat([spec_11715008.typ]), parent: null, m_type: NTI1194643, name: null, trace: [], up: null}, "ValueError");
      break;
    }
    result_11715005[result_11715005_Idx].push.apply(result_11715005[result_11715005_Idx], formatInt_11720002(value_11715006, radix_11715010, spec_11715008));;
  } while (false);

  
}
function toCode_11710044(e_11710046) {
  var result_11710047 = null;

    var fmtRes_11710048 = [mnewString(0)];
    fmtRes_11710048[0].push.apply(fmtRes_11710048[0], makeNimstrLit("{\"code\": "));;
    formatValue_11715002(fmtRes_11710048, 0, e_11710046.code, []);
    fmtRes_11710048[0].push.apply(fmtRes_11710048[0], makeNimstrLit(", \"message\": \""));;
    add_1357211(fmtRes_11710048, 0, e_11710046.message);
    fmtRes_11710048[0].push.apply(fmtRes_11710048[0], makeNimstrLit("\"}"));;
    result_11710047 = toJSStr(fmtRes_11710048[0]);

  return result_11710047;

}
function toCode_11775014(r_11775016) {
      var Tmp1;
      var Tmp2;
      var Tmp3;
      var Tmp4;
  ...
  var result_11775017 = null;

    result_11775017 = "{\"jsonrpc\": \"2.0\"";
    switch (r_11775016.kind) {
    case 0:
      var fmtRes_11775018 = [mnewString(0)];
      fmtRes_11775018[0].push.apply(fmtRes_11775018[0], makeNimstrLit(", \"result\": "));;
      var Tmp1 = r_11775016;
      if (ConstSet11[Tmp1.kind]===undefined) { raiseFieldError(makeNimstrLit("\'result\' is not accessible using discriminant \'kind\' of type \'Response\'")); }
      add_1357211(fmtRes_11775018, 0, toCode_11666107(Tmp1.result));
      if (null != (Tmp2 = toJSStr(fmtRes_11775018[0]), Tmp2)) { if (null == result_11775017) result_11775017 = Tmp2; else result_11775017 += Tmp2; };
      break;
    case 1:
      var Tmp3 = r_11775016;
      if (ConstSet19[Tmp3.kind]===undefined) { raiseFieldError(makeNimstrLit("\'error\' is not accessible using discriminant \'kind\' of type \'Response\'")); }
      if (null != (Tmp4 = toCode_11710044(Tmp3.error), Tmp4)) { if (null == result_11775017) result_11775017 = Tmp4; else result_11775017 += Tmp4; };
      break;
    }
    if (!(r_11775016.notification)) {
    var fmtRes_11795001 = mnewString(0);
    fmtRes_11795001.push.apply(fmtRes_11795001, makeNimstrLit(", \"id\": 1"));;
    if (null != (Tmp5 = toJSStr(fmtRes_11795001), Tmp5)) { if (null == result_11775017) result_11775017 = Tmp5; else result_11775017 += Tmp5; };
    }
    
    if (null != "}") { if (null == result_11775017) result_11775017 = "}"; else result_11775017 += "}"; };

  return result_11775017;

}
function createDom_11811014() {
                    var Tmp7;
                      var Tmp8;
                      var Tmp9;
                      var Tmp10;
  ...
  var result_11811016 = null;

    var tmp_11811053 = tree_10560445(43, []);
    var tmp_11811054 = tree_10560445(21, []);
    add_10550072(tmp_11811054, text_10560582(makeNimstrLit("Kisa API documentation")));
    add_10550072(tmp_11811053, tmp_11811054);
    L1: do {
      var interaction_11825214 = null;
      var i_11835499 = 0;
      var L_11835500 = (interactions_11810030[0]).length;
      L2: do {
          L3: while (true) {
          if (!(i_11835499 < L_11835500)) break L3;
            interaction_11825214 = interactions_11810030[0][chckIndx(i_11835499, 0, (interactions_11810030[0]).length-1)];
            var tmp_11811059 = tree_10560445(22, []);
            add_10550072(tmp_11811059, text_10560801(interaction_11825214.title));
            add_10550072(tmp_11811053, tmp_11811059);
            var tmp_11811060 = tree_10560445(31, []);
            add_10550072(tmp_11811060, text_10560801(interaction_11825214.description));
            add_10550072(tmp_11811053, tmp_11811060);
            var tmp_11811061 = tree_10560445(35, []);
            L4: do {
              var step_11835214 = null;
              var i_11835495 = 0;
              var L_11835496 = (interaction_11825214.steps).length;
              L5: do {
                  L6: while (true) {
                  if (!(i_11835495 < L_11835496)) break L6;
                    step_11835214 = interaction_11825214.steps[chckIndx(i_11835495, 0, (interaction_11825214.steps).length-1)];
                    var tmp_11811062 = tree_10560445(37, []);
                    var tmp_11811063 = tree_10560445(31, []);
                    add_10550072(tmp_11811063, text_10560801(step_11835214.description));
                    add_10550072(tmp_11811062, tmp_11811063);
                    var tmp_11811064 = tree_10560445(33, []);
                    switch (step_11835214.kind) {
                    case 2:
                      var Tmp8 = step_11835214;
                    ...
                    case 0:
                      ...
                      var str_11835229 = nimCopy(null, Tmp10, NTI1188013);
                      var Tmp11 = step_11835214;
                      if (ConstSet9[Tmp11.kind]===undefined) { raiseFieldError(makeNimstrLit("\'request\' is not accessible using discriminant \'kind\' of type \'Step\'")); }
                      Tmp7 = (toJSStr(str_11835229) + toCode_11735015(Tmp11.request));
                      break;
                    case 1:
                      var Tmp12 = step_11835214;
                      if (ConstSet10[Tmp12.kind]===undefined) { raiseFieldError(makeNimstrLit("\'from\' is not accessible using discriminant \'kind\' of type \'Step\'")); }
                      switch (Tmp12.from) {
                      case 1:
                      ...
                      var str_11835232 = nimCopy(null, Tmp13, NTI1188013);
                      var Tmp14 = step_11835214;
                      ...
                      Tmp7 = (toJSStr(str_11835232) + toCode_11775014(Tmp14.response));
                      break;
                    }
                    add_10550072(tmp_11811064, text_10560801(Tmp7));
                    add_10550072(tmp_11811062, tmp_11811064);
                    add_10550072(tmp_11811061, tmp_11811062);
                    i_11835495 = addInt(i_11835495, 1);
                    if (!(((interaction_11825214.steps).length == L_11835496))) {
                    failedAssertImpl_1305480(makeNimstrLit("iterators.nim(204, 11) `len(a) == L` the length of the seq changed while iterating over it"));
                    }
            ...
            add_10550072(tmp_11811053, tmp_11811061);
            i_11835499 = addInt(i_11835499, 1);
            if (!(((interactions_11810030[0]).length == L_11835500))) {
            failedAssertImpl_1305480(makeNimstrLit("iterators.nim(204, 11) `len(a) == L` the length of the seq changed while iterating over it"));
            }
    ...
    result_11811016 = tmp_11811053;

  return result_11811016;

}
setRenderer_11455238(createDom_11811014, "ROOT", null);

...
function nimMin(a_1460803, b_1460804) {
  ...
  return result_1460805;
            ...
            var interactions_17515645 = [{title: makeNimstrLit("Initialize a client"), description: makeNimstrLit("The first thing the client should do is to connect to the server and receive and ID.\x0A"), steps: [{description: makeNimstrLit("The first thing to do is to send a connection request to unix domain socket which\x0Ais located at user runtime directory inside <code>kisa</code> directory with an &lt;ID&gt; of a\x0Acurrently running session (by convention it is the process ID of the server).\x0ABelow is an example for a Zig language, see documentation of\x0A<a href=\"https://linux.die.net/man/2/socket\">socket(2)</a> and <a href=\"https://linux.die.net/man/2/connect\">connect(2)</a> for more information.\x0A\x0A\x0A\x0A"), kind: 2, request: {method: [], params: {kind: 0, vVal: false, bVal: false, iVal: 0, fVal: 0.0, sVal: [], aVal: []}, notification: false}, to: 0, response: {notification: false, kind: 0, result: {kind: 0, vVal: false, bVal: false, iVal: 0, fVal: 0.0, sVal: [], aVal: []}, error: {code: 0, message: []}}, from: 0, other: makeNimstrLit("const std = @import(\"std\");\x0Aconst os = std.os;\x0Aconst allocator = ...;\x0Aconst address = allocator.create(std.net.Address);\x0Aaddress.* = try std.net.Address.initUnix(\"/var/run/user/1000/kisa/<ID>\");\x0Aconst socket = try os.socket(\x0A    os.AF_UNIX,\x0A    os.SOCK_SEQPACKET | os.SOCK_CLOEXEC,\x0A    os.PF_UNIX,\x0A);\x0Aos.connect(socket, &address.any, address.getOsSockLen());\x0A")}, {description: makeNimstrLit("After that the server notifies the client that the connection was accepted\x0Aand sends a notification saying that the client must ask for its ID.\x0A"), kind: 0, request: {method: makeNimstrLit("shouldAskId"), params: {kind: 0, vVal: false, bVal: false, iVal: 0, fVal: 0.0, sVal: [], aVal: []}, notification: true}, to: 0, response: {notification: false, kind: 0, result: {kind: 0, vVal: false, bVal: false, iVal: 0, fVal: 0.0, sVal: [], aVal: []}, error: {code: 0, message: []}}, from: 0, other: []}, {description: makeNimstrLit("After receiving a notification, the client asks for an ID.\x0A"), kind: 0, request: {method: makeNimstrLit("askId"), params: {kind: 0, vVal: false, bVal: false, iVal: 0, fVal: 0.0, sVal: [], aVal: []}, notification: false}, to: 1, response: {notification: false, kind: 0, result: {kind: 0, vVal: false, bVal: false, iVal: 0, fVal: 0.0, sVal: [], aVal: []}, error: {code: 0, message: []}}, from: 0, other: []}, {description: makeNimstrLit("Server sends an ID which it assigned to the client.\x0A"), kind: 1, request: {method: [], params: {kind: 0, vVal: false, bVal: false, iVal: 0, fVal: 0.0, sVal: [], aVal: []}, notification: false}, to: 0, response: {notification: false, kind: 0, result: {kind: 1, vVal: false, bVal: true, iVal: 0, fVal: 0.0, sVal: [], aVal: []}, error: {code: 0, message: []}}, from: 1, other: []}]}];
...
function applyEvents_11010073(n_11010075) {
    ...
    L1: do {
      var i_11010089 = 0;
      var colontmp__17540367 = 0;
      colontmp__17540367 = (n_11010075.events).length;
      var i_17540368 = 0;
      L2: do {
          L3: while (true) {
          if (!(i_17540368 < colontmp__17540367)) break L3;
            i_11010089 = i_17540368;
...
function applyStyle_10455628(n_10455630, s_10455631) {
    ...
    L1: do {
      var i_10455664 = 0;
      var colontmp__17540378 = 0;
      colontmp__17540378 = (s_10455631.length - 1);
      var res_17540379 = 0;
      L2: do {
          L3: while (true) {
          if (!(res_17540379 <= colontmp__17540378)) break L3;
            i_10455664 = res_17540379;
  ...
  BeforeRet: do {
    ...
    break BeforeRet;
      ...
      L1: do {
        ...
        L2: do {
          var i_17540347 = 0;
          var colontmp__17540348 = 0;
          colontmp__17540348 = (n_11010156.kids).length;
          var i_17540349 = 0;
          L3: do {
              L4: while (true) {
              if (!(i_17540349 < colontmp__17540348)) break L4;
                i_17540347 = i_17540349;
                k_11135016 = n_11010156.kids[i_17540347];
    ...
    L5: do {
      ...
      L6: do {
        var i_17540360 = 0;
        var colontmp__17540361 = 0;
        colontmp__17540361 = ((n_11010156.attrs).length - 2);
        var res_17540362 = 0;
        L7: do {
            L8: while (true) {
            if (!(res_17540362 <= colontmp__17540361)) break L8;
              i_17540360 = res_17540362;
              k_11150001 = n_11010156.attrs[i_17540360];
              v_11150002 = n_11010156.attrs[(i_17540360 + 1)];
              if (!((v_11150002 == null))) {
...
function same_11160072(n_11160074, e_11160075, nesting_11160076) {
  ...
  BeforeRet: do {
    ...
    L3: do {
      var i_11175208 = 0;
      var colontmp__17540385 = 0;
      colontmp__17540385 = len_10550014(n_11160074);
      var i_17540386 = 0;
      L4: do {
          L5: while (true) {
          if (!(i_17540386 < colontmp__17540385)) break L5;
            i_11175208 = i_17540386;
...
function eq_10420229(a_10420231, b_10420232) {
  ...
  BeforeRet: do {
    ...
    L1: do {
      var i_10425083 = 0;
      var colontmp__17540427 = 0;
      colontmp__17540427 = a_10420231.length;
      var i_17540428 = 0;
      L2: do {
          L3: while (true) {
          if (!(i_17540428 < colontmp__17540427)) break L3;
            i_10425083 = i_17540428;
...
function sameAttrs_10561079(a_10561081, b_10561082) {
  ...
  BeforeRet: do {
    ...
    L1: do {
      var i_10561106 = 0;
      var colontmp__17540431 = 0;
      colontmp__17540431 = (a_10561081.attrs).length;
      var i_17540432 = 0;
      L2: do {
          L3: while (true) {
          if (!(i_17540432 < colontmp__17540431)) break L3;
            i_10561106 = i_17540432;
...
function eq_11175614(a_11175616, b_11175617, recursive_11175618) {
  ...
  BeforeRet: do {
    ...
    L1: do {
      var i_11205008 = 0;
      var colontmp__17540419 = 0;
      colontmp__17540419 = len_10550014(a_11175616);
      var i_17540420 = 0;
      L2: do {
          L3: while (true) {
          if (!(i_17540420 < colontmp__17540419)) break L3;
            i_11205008 = i_17540420;
    ...
    L6: do {
      var i_11230008 = 0;
      var colontmp__17540423 = 0;
      colontmp__17540423 = len_10550014(a_11175616);
      var i_17540424 = 0;
      L7: do {
          L8: while (true) {
          if (!(i_17540424 < colontmp__17540423)) break L8;
            i_11230008 = i_17540424;
...
function updateAttributes_11245052(newNode_11245054, oldNode_11245055) {
    ...
    L1: do {
      ...
      L2: do {
        var i_17540437 = 0;
        var colontmp__17540438 = 0;
        colontmp__17540438 = ((oldNode_11245055.attrs).length - 2);
        var res_17540439 = 0;
        L3: do {
            L4: while (true) {
            if (!(res_17540439 <= colontmp__17540438)) break L4;
              i_17540437 = res_17540439;
              k_11250009 = oldNode_11245055.attrs[i_17540437];
              __11250010 = oldNode_11245055.attrs[(i_17540437 + 1)];
    ...
    L5: do {
      ...
      L6: do {
        var i_17540445 = 0;
        var colontmp__17540446 = 0;
        colontmp__17540446 = ((newNode_11245054.attrs).length - 2);
        var res_17540447 = 0;
        L7: do {
            L8: while (true) {
            if (!(res_17540447 <= colontmp__17540446)) break L8;
              i_17540445 = res_17540447;
              k_11250011 = newNode_11245054.attrs[i_17540445];
              v_11250012 = newNode_11245054.attrs[(i_17540445 + 1)];
              if (!((v_11250012 == null))) {
...
function getAttr_10500183(n_10500185, key_10500186) {
  ...
  BeforeRet: do {
    L1: do {
      var i_10500200 = 0;
      var colontmp__17540452 = 0;
      colontmp__17540452 = ((n_10500185.attrs).length - 2);
      var res_17540453 = 0;
      L2: do {
          L3: while (true) {
          if (!(res_17540453 <= colontmp__17540452)) break L3;
            i_10500200 = res_17540453;
...
function removeAllEventHandlers_10897437(d_10897439) {
    ...
    L1: do {
      var i_10900041 = 0;
      var colontmp__17540459 = 0;
      colontmp__17540459 = d_10897439.karaxEvents.length;
      var i_17540460 = 0;
      L2: do {
          L3: while (true) {
          if (!(i_17540460 < colontmp__17540459)) break L3;
            i_10900041 = i_17540460;
...
function diff_11310215(newNode_11310217, oldNode_11310218, parent_11310219, current_11310220, kxi_11310221) {
  ...
  BeforeRet: do {
    ...
    case 2:
      ...
      L8: do {
        var i_11340024 = 0;
        var colontmp__17540394 = 0;
        colontmp__17540394 = (pos_11340018 - 1);
        var res_17540395 = commonPrefix_11330202;
        L9: do {
            L10: while (true) {
            if (!(res_17540395 <= colontmp__17540394)) break L10;
              i_11340024 = res_17540395;
      ...
      L11: do {
        var i_11340030 = 0;
        var res_17540401 = pos_11340018;
        L12: do {
            L13: while (true) {
            if (!(res_17540401 <= newPos_11330215)) break L13;
              i_11340030 = res_17540401;
        ...
        L14: do {
          var i_11340037 = 0;
          var res_17540407 = pos_11340018;
          L15: do {
              L16: while (true) {
              if (!(res_17540407 <= newPos_11330215)) break L16;
                i_11340037 = res_17540407;
      ...
      L17: do {
        var i_11340043 = 0;
        var res_17540413 = pos_11340018;
        L18: do {
            L19: while (true) {
            if (!(res_17540413 <= oldPos_11330214)) break L19;
              i_11340043 = res_17540413;
...
function moveDom_11270048(dest_11270050, src_11270051) {
    ...
    L1: do {
      var i_11285208 = 0;
      var colontmp__17540471 = 0;
      colontmp__17540471 = len_10550014(dest_11270050);
      var i_17540472 = 0;
      L2: do {
          L3: while (true) {
          if (!(i_17540472 < colontmp__17540471)) break L3;
            i_11285208 = i_17540472;
...
function applyPatch_11285222(kxi_11285224) {
    L1: do {
      ...
      L2: do {
          L3: while (true) {
          if (!(i_17540465 < kxi_11285224.patchLen)) break L3;
            i_11285232 = i_17540465;
    ...
    L4: do {
      ...
      L5: do {
          L6: while (true) {
          if (!(i_17540468 < kxi_11285224.patchLenV)) break L6;
            i_11295013 = i_17540468;
...
function tree_10560445(kind_10560447, kids_10560449) {
  var result_10560450 = null;
    ...
    L1: do {
      ...
      L2: do {
          L3: while (true) {
          if (!(i_17540494 < (kids_10560449).length)) break L3;
            k_10560483 = kids_10560449; k_10560483_Idx = i_17540494;
...
function HEX5BHEX5D_5890068(s_5890072, x_5890074) {
  var result_5890075 = [];
    ...
    L1: do {
      ...
      L2: do {
          L3: while (true) {
          if (!(i_17515629 < L_5890401)) break L3;
            i_5890409 = i_17515629;
...
function quoteString_17426075(str_17426077) {
  var result_17426078 = [];

    L1: do {
      var ch_17426080 = 0;
      var i_17540533 = 0;
      var L_17540534 = (str_17426077).length;
      L2: do {
          L3: while (true) {
          if (!(i_17540533 < L_17540534)) break L3;
            ch_17426080 = str_17426077[i_17540533];
            if ((ch_17426080 == 34)) {
            addChar(result_17426078, 92);;
            addChar(result_17426078, 34);;
            }
            else {
            addChar(result_17426078, ch_17426080);;
            }
  ...
  return result_17426078;

}
function toCode_17426094(p_17426096) {
      var Tmp1;
      var Tmp2;
      var Tmp3;
      var Tmp4;
  ...
  var result_17426097 = [];
    ...
    case 1:
      ...
      result_17426097 = nimCopy(null, nimBoolToStr(Tmp1.bVal), NTI1188013);
      break;
    case 2:
      var Tmp2 = p_17426096;
      ...
      result_17426097 = nimCopy(null, cstrToNimstr((Tmp2.iVal)+""), NTI1188013);
      break;
    case 3:
      var Tmp3 = p_17426096;
      ...
      result_17426097 = nimCopy(null, cstrToNimstr(nimFloatToString(Tmp3.fVal)), NTI1188013);
      break;
    case 4:
      ...
      formatValue_11595080(fmtRes_17435204, 0, quoteString_17426075(Tmp4.sVal), []);
      fmtRes_17435204[0].push.apply(fmtRes_17435204[0], makeNimstrLit("\""));;
      result_17426097 = nimCopy(null, fmtRes_17435204[0], NTI1188013);
      break;
    case 5:
      result_17426097 = nimCopy(null, makeNimstrLit("["), NTI1188013);
      L5: do {
        var parameter_17450214 = null;
        var colontmp__17540527 = [];
        var Tmp6 = p_17426096;
        if (ConstSet15[Tmp6.kind]===undefined) { raiseFieldError(makeNimstrLit("\'aVal\' is not accessible using discriminant \'kind\' of type \'Parameter\'")); }
        colontmp__17540527 = Tmp6.aVal;
        var i_17540529 = 0;
        var L_17540530 = (colontmp__17540527).length;
        L7: do {
            L8: while (true) {
            if (!(i_17540529 < L_17540530)) break L8;
              parameter_17450214 = colontmp__17540527[i_17540529];
              result_17426097.push.apply(result_17426097, toCode_17426094(parameter_17450214));;
              result_17426097.push.apply(result_17426097, makeNimstrLit(", "));;
              i_17540529 += 1;
            }
        } while(false);
      } while(false);
  ...
  return result_17426097;

}
function toCode_17470063(r_17470065) {
  var result_17470066 = [];

    var fmtRes_17470067 = [mnewString(0)];
    fmtRes_17470067[0].push.apply(fmtRes_17470067[0], makeNimstrLit("{\"jsonrpc\": \"2.0\", \"method\": \""));;
    formatValue_11595080(fmtRes_17470067, 0, r_17470065.method, []);
    fmtRes_17470067[0].push.apply(fmtRes_17470067[0], makeNimstrLit("\""));;
    result_17470066 = nimCopy(null, fmtRes_17470067[0], NTI1188013);
    if (!((r_17470065.params.kind == 0))) {
    var fmtRes_17480006 = [mnewString(0)];
    fmtRes_17480006[0].push.apply(fmtRes_17480006[0], makeNimstrLit(", \"params\": "));;
    formatValue_11595080(fmtRes_17480006, 0, toCode_17426094(r_17470065.params), []);
    result_17470066.push.apply(result_17470066, fmtRes_17480006[0]);;
    }
    
    if (!(r_17470065.notification)) {
    result_17470066.push.apply(result_17470066, makeNimstrLit(", \"id\": 1"));;
    }
    
    result_17470066.push.apply(result_17470066, makeNimstrLit("}"));;

  return result_17470066;
...
function mkDigit_11541055(v_11541057, typ_11541058) {
  ...
  var result_11541059 = [];
    ...
    if ((v_11541057 < 10)) {
    result_11541059 = nimCopy(null, nimCharToStr((48 + v_11541057)), NTI1188013);
    }
    else {
      if ((typ_11541058 == 120)) {
      Tmp1 = 97;
      ...
      result_11541059 = nimCopy(null, nimCharToStr(((Tmp1 + v_11541057) - 10)), NTI1188013);
    }
...
function formatInt_17460002(n_17460005, radix_17460006, spec_17460007) {
    var Tmp7;

  var result_17460008 = [];

    var v_17460201 = n_17460005;
    var negative_17460202 = (v_17460201 < 0);
    if (negative_17460202) {
    v_17460201 = (v_17460201 * -1);
    }
    
    var xx_17460203 = [];
    if (spec_17460007.alternateForm) {
    switch (spec_17460007.typ) {
    case 88:
      xx_17460203 = nimCopy(null, makeNimstrLit("0x"), NTI1188013);
      break;
    case 120:
      xx_17460203 = nimCopy(null, makeNimstrLit("0x"), NTI1188013);
      break;
    case 98:
      xx_17460203 = nimCopy(null, makeNimstrLit("0b"), NTI1188013);
      break;
    case 111:
      xx_17460203 = nimCopy(null, makeNimstrLit("0o"), NTI1188013);
      break;
    default: 
      break;
    }
    ...
    if ((v_17460201 == 0)) {
    result_17460008 = nimCopy(null, makeNimstrLit("0"), NTI1188013);
    }
    else {
      result_17460008 = nimCopy(null, [], NTI1188013);
      L1: do {
          L2: while (true) {
          if (!(0 < v_17460201)) break L2;
            var d_17460206 = Math.trunc(v_17460201 % radix_17460006);
            v_17460201 = Math.trunc(v_17460201 / radix_17460006);
            result_17460008.push.apply(result_17460008, mkDigit_11541055(d_17460206, spec_17460007.typ));;
          }
      } while(false);
      L3: do {
        var idx_17460215 = 0;
        var colontmp__17540541 = 0;
        colontmp__17540541 = Math.trunc((result_17460008).length / 2);
        var i_17540542 = 0;
        L4: do {
            L5: while (true) {
            if (!(i_17540542 < colontmp__17540541)) break L5;
              idx_17460215 = i_17540542;
              var Tmp6 = result_17460008[idx_17460215]; result_17460008[idx_17460215] = result_17460008[(((result_17460008).length - idx_17460215) - 1)]; result_17460008[(((result_17460008).length - idx_17460215) - 1)] = Tmp6;              i_17540542 += 1;
            }
        } while(false);
      } while(false);
    }
    
    if (spec_17460007.padWithZero) {
    if (negative_17460202) Tmp7 = true; else {      Tmp7 = !((spec_17460007.sign == 45));    }    var sign_17470008 = Tmp7;
    var toFill_17470013 = (((spec_17460007.minimumWidth - (result_17460008).length) - (xx_17460203).length) - (sign_17470008 ? 1:0));
    if ((0 < toFill_17470013)) {
    result_17460008 = nimCopy(null, (nsuRepeatChar(48, toFill_17470013) || []).concat(result_17460008 || []), NTI1188013);
    }
    
    }
    
    if (negative_17460202) {
    result_17460008 = nimCopy(null, (makeNimstrLit("-") || []).concat(xx_17460203 || [],result_17460008 || []), NTI1188013);
    }
    else {
    if (!((spec_17460007.sign == 45))) {
    result_17460008 = nimCopy(null, [spec_17460007.sign].concat(xx_17460203 || [],result_17460008 || []), NTI1188013);
    }
    else {
      result_17460008 = nimCopy(null, (xx_17460203 || []).concat(result_17460008 || []), NTI1188013);
    }
    }
    if ((spec_17460007.align == 60)) {
    L8: do {
      var i_17470019 = 0;
      var colontmp__17540545 = 0;
      colontmp__17540545 = (result_17460008).length;
      var i_17540546 = colontmp__17540545;
      L9: do {
          L10: while (true) {
          if (!(i_17540546 < spec_17460007.minimumWidth)) break L10;
            i_17470019 = i_17540546;
            addChar(result_17460008, spec_17460007.fill);;
            i_17540546 += 1;
          }
      } while(false);
    } while(false);
      ...
      var toFill_17470020 = (spec_17460007.minimumWidth - (result_17460008).length);
      if ((spec_17460007.align == 94)) {
      var half_17470021 = Math.trunc(toFill_17470020 / 2);
      result_17460008 = nimCopy(null, (nsuRepeatChar(spec_17460007.fill, half_17470021) || []).concat(result_17460008 || [],nsuRepeatChar(spec_17460007.fill, (toFill_17470020 - half_17470021)) || []), NTI1188013);
      }
      else {
        if ((0 < toFill_17470020)) {
        result_17460008 = nimCopy(null, (nsuRepeatChar(spec_17460007.fill, toFill_17470020) || []).concat(result_17460008 || []), NTI1188013);
        }
  ...
  return result_17460008;

}
function formatValue_17455002(result_17455005, result_17455005_Idx, value_17455006, specifier_17455007) {
  BeforeRet: do {
    if (((specifier_17455007).length == 0)) {
    result_17455005[result_17455005_Idx].push.apply(result_17455005[result_17455005_Idx], cstrToNimstr((value_17455006)+""));;
    break BeforeRet;
    }
    
    var spec_17455008 = parseStandardFormatSpecifier_11550322(specifier_17455007, 0, false);
    var radix_17455010 = 10;
    switch (spec_17455008.typ) {
    case 120:
    case 88:
      radix_17455010 = 16;
      break;
    ...
    case 111:
      ...
      break;
    default: 
      raiseException({message: (makeNimstrLit("invalid type in format string for number, expected one  of \'x\', \'X\', \'b\', \'d\', \'o\' but got: ") || []).concat([spec_17455008.typ]), parent: null, m_type: NTI1194643, name: null, trace: [], up: null}, "ValueError");
      break;
    }
    result_17455005[result_17455005_Idx].push.apply(result_17455005[result_17455005_Idx], formatInt_17460002(value_17455006, radix_17455010, spec_17455008));;
  } while (false);

  
}
function toCode_17450259(e_17450261) {
  var result_17450262 = [];

    var fmtRes_17450263 = [mnewString(0)];
    fmtRes_17450263[0].push.apply(fmtRes_17450263[0], makeNimstrLit("{\"code\": "));;
    formatValue_17455002(fmtRes_17450263, 0, e_17450261.code, []);
    fmtRes_17450263[0].push.apply(fmtRes_17450263[0], makeNimstrLit(", \"message\": \""));;
    formatValue_11595080(fmtRes_17450263, 0, e_17450261.message, []);
    fmtRes_17450263[0].push.apply(fmtRes_17450263[0], makeNimstrLit("\"}"));;
    result_17450262 = nimCopy(null, fmtRes_17450263[0], NTI1188013);

  return result_17450262;

}
function toCode_17485016(r_17485018) {
      var Tmp1;
      var Tmp2;

  var result_17485019 = [];

    result_17485019 = nimCopy(null, makeNimstrLit("{\"jsonrpc\": \"2.0\""), NTI1188013);
    switch (r_17485018.kind) {
    case 0:
      var fmtRes_17485020 = [mnewString(0)];
      fmtRes_17485020[0].push.apply(fmtRes_17485020[0], makeNimstrLit(", \"result\": "));;
      var Tmp1 = r_17485018;
      if (ConstSet18[Tmp1.kind]===undefined) { raiseFieldError(makeNimstrLit("\'result\' is not accessible using discriminant \'kind\' of type \'Response\'")); }
      formatValue_11595080(fmtRes_17485020, 0, toCode_17426094(Tmp1.result), []);
      result_17485019.push.apply(result_17485019, fmtRes_17485020[0]);;
      break;
    case 1:
      var Tmp2 = r_17485018;
      if (ConstSet19[Tmp2.kind]===undefined) { raiseFieldError(makeNimstrLit("\'error\' is not accessible using discriminant \'kind\' of type \'Response\'")); }
      result_17485019.push.apply(result_17485019, toCode_17450259(Tmp2.error));;
      break;
    }
    if (!(r_17485018.notification)) {
    var fmtRes_17490005 = mnewString(0);
    fmtRes_17490005.push.apply(fmtRes_17490005, makeNimstrLit(", \"id\": 1"));;
    result_17485019.push.apply(result_17485019, fmtRes_17490005);;
    }
    
    result_17485019.push.apply(result_17485019, makeNimstrLit("}"));;

  return result_17485019;

}
function createDom_17516014() {
                    var Tmp7;
                      var Tmp8;
                      var Tmp9;
                      var Tmp10;
  ...
  var result_17516016 = null;

    var tmp_17516049 = tree_10560445(43, []);
    var tmp_17516050 = tree_10560445(21, []);
    add_10550072(tmp_17516050, text_10560582(makeNimstrLit("Kisa API documentation")));
    add_10550072(tmp_17516049, tmp_17516050);
    L1: do {
      var interaction_17530214 = null;
      var i_17540489 = 0;
      var L_17540490 = 1;
      L2: do {
          L3: while (true) {
          if (!(i_17540489 < L_17540490)) break L3;
            interaction_17530214 = interactions_17515645[i_17540489];
            var tmp_17516055 = tree_10560445(22, []);
            add_10550072(tmp_17516055, text_10560582(interaction_17530214.title));
            add_10550072(tmp_17516049, tmp_17516055);
            var tmp_17516056 = tree_10560445(31, []);
            add_10550072(tmp_17516056, verbatim_10560819(interaction_17530214.description));
            add_10550072(tmp_17516049, tmp_17516056);
            var tmp_17516057 = tree_10560445(35, []);
            L4: do {
              var step_17540214 = null;
              var i_17540485 = 0;
              var L_17540486 = (interaction_17530214.steps).length;
              L5: do {
                  L6: while (true) {
                  if (!(i_17540485 < L_17540486)) break L6;
                    step_17540214 = interaction_17530214.steps[i_17540485];
                    var tmp_17516058 = tree_10560445(37, []);
                    var tmp_17516059 = tree_10560445(31, []);
                    add_10550072(tmp_17516059, verbatim_10560819(step_17540214.description));
                    add_10550072(tmp_17516058, tmp_17516059);
                    var tmp_17516060 = tree_10560445(33, []);
                    switch (step_17540214.kind) {
                    case 2:
                      var Tmp8 = step_17540214;
                    ...
                    case 0:
                      ...
                      var str_17540229 = nimCopy(null, Tmp10, NTI1188013);
                      var Tmp11 = step_17540214;
                      if (ConstSet16[Tmp11.kind]===undefined) { raiseFieldError(makeNimstrLit("\'request\' is not accessible using discriminant \'kind\' of type \'Step\'")); }
                      Tmp7 = (str_17540229 || []).concat(toCode_17470063(Tmp11.request) || []);
                      break;
                    case 1:
                      var Tmp12 = step_17540214;
                      if (ConstSet17[Tmp12.kind]===undefined) { raiseFieldError(makeNimstrLit("\'from\' is not accessible using discriminant \'kind\' of type \'Step\'")); }
                      switch (Tmp12.from) {
                      case 1:
                      ...
                      var str_17540232 = nimCopy(null, Tmp13, NTI1188013);
                      var Tmp14 = step_17540214;
                      if (ConstSet20[Tmp14.kind]===undefined) { raiseFieldError(makeNimstrLit("\'response\' is not accessible using discriminant \'kind\' of type \'Step\'")); }
                      Tmp7 = (str_17540232 || []).concat(toCode_17485016(Tmp14.response) || []);
                      break;
                    }
                    add_10550072(tmp_17516060, text_10560582(Tmp7));
                    add_10550072(tmp_17516058, tmp_17516060);
                    add_10550072(tmp_17516057, tmp_17516058);
                    i_17540485 += 1;
                  }
              } while(false);
            } while(false);
            add_10550072(tmp_17516049, tmp_17516057);
            i_17540489 += 1;
          }
      } while(false);
    } while(false);
    result_17516016 = tmp_17516049;

  return result_17516016;

}
setRenderer_11455238(createDom_17516014, "ROOT", null);
